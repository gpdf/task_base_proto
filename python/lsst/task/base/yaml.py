...
"""This module defines YAML I/O for key lsst.task.base classes."""
...
def tm_representer(dumper, data):
    """Represent an lsst.task.base.TaskMetadata as a mapping.
    """
    return dumper.represent_mapping('lsst.task.base.TaskMetadata', data)
...
def tm_constructor(loader, node):
    """Construct an lsst.task.base.TaskMetadata from a YAML serialization.
    """
...
if yaml:
    for loader in yaml_loaders:
        yaml.add_constructor('lsst.task.base.TaskMetadata', tm_constructor, Loader=loader)
